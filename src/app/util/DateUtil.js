export default class DateUtil {
    static  getTodaysISODate() {
        ...
        let todaysMonth = today.getMonth() + 1 > 9 ? today.getMonth() + 1 : "0" + (today.getMonth() + 1);
        let todaysDate = today.getDate() > 9 ? today.getDate() : "0" + today.getDate();
        return todaysYear + '-' + todaysMonth + '-' + todaysDate;
    }

    static getISODateTime(JSDate) {
        let year = JSDate.getFullYear();
        let month = JSDate.getMonth() + 1 > 9 ? JSDate.getMonth() + 1 : "0" + (JSDate.getMonth() + 1);
        let day = JSDate.getDate() > 9 ? JSDate.getDate() : "0" + JSDate.getDate();
        let hours = JSDate.getHours() > 9 ? JSDate.getHours() : "0" + JSDate.getHours();
        let minutes = JSDate.getMinutes() > 9 ? JSDate.getMinutes() : "0" + JSDate.getMinutes();
        let seconds = JSDate.getSeconds() > 9 ? JSDate.getSeconds() : "0" + JSDate.getSeconds();
