...
const useStyles = makeStyles((theme) => {
   ...
   return {
      ...
      streamCard: {
         ...
         zIndex: ({ cardHovered, isExpanded }) =>
            (cardHovered || isExpanded) && 995,
         "& p": {
      ...
      companyLogoWrapper: {
         ...
         alignItems: "center",
         justifyContent: "center",
         borderRadius: ({ cardHovered }) =>
            cardHovered && `${theme.spacing(2)}px 0px`,
      ...
      companyName: {
         ...
         WebkitLineClamp: ({ cardHovered, isExpanded }) =>
            cardHovered || isExpanded ? 3 : 2,
      },
      front: {
         position: "relative",
         width: "100%",
         ...
         transform: ({ cardHovered }) =>
            cardHovered && `translateY(${-50}px) scale(${frontHoveredScale})`,
         background: ({ cardHovered, registered }) =>
            cardHovered
               ? "transparent"
               : registered
               ? theme.palette.primary.dark
               : theme.palette.navyBlue.main,
         boxShadow: ({ cardHovered }) => cardHovered && "none",
         height: ({ cardHovered }) => cardHovered && "fit-content",
         borderRadius: ({ expanded }) =>
            expanded ? `${theme.spacing(2.5)}px` : theme.spacing(2.8),
      },
      ...
      backgroundContent: {
         marginTop: ({ hideActions, hasOptions }) =>
      ...
      expandButton: {
         ...
         borderRadius: ({ hasGroups, isAdmin }) =>
            isAdmin && hasGroups ? 0 : theme.spacing(2.5),
      },
                              ...
                              {!cardHovered && (
                                 <>
                                       ...
                                       <div className={classes.expandArea}>
                                          ...
                                          <Collapse mountOnEnter in={expanded}>
                                             ...
                                             {!!targetOptions.length && (
                                                <div
                                                   className={
                                                      classes.expandedOptionsWrapper
                                                   }
                                                >
                                                   <TargetOptions
                                                      className={
                                    ...
                                    <Fade in={Boolean(careerCenters.length)}>
                                       <div
                                          className={
                                             classes.companyLogosFrontWrapper
                                          }
                                       >
                                          <div
                                             className={
                                                classes.logosFrontInnerWrapper
                                             }
                                          >
                                             <Row
                                                p={1}
