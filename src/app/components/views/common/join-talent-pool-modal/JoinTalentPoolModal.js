...
function JoinTalentPoolModal({livestream, userData, modalOpen, setModalOpen, firebase}) {
    ...
    const JoiningConfirmation = ({}) => {
        return (
            <div className={classes.container}>
                ...
                <Typography className={classes.title} variant='h4'>Thank you for the joining the talent pool!</Typography>
        ...
        <Fragment>
            <Dialog style={{zIndex: '9999'}} open={modalOpen}>
                <DialogContent>
                    ...
                    {
                        (withCV === false || ( withCV === true && userData?.userResume)) &&
                        <JoiningConfirmation/>
                    }
                </DialogContent>
            </Dialog>
...
export default withFirebase(JoinTalentPoolModal);