                    ...
                    <div className={registration ? 'hidden' : ''} style={{textAlign: 'center'}}>
                        ...
                        <div className={modalStep !== 2 ? 'hidden' : 'modalStep animated fadeIn'}>
                            ...
                            <div style={{
                                ...
                                color: 'rgb(70,70,200)',
                                cursor: 'pointer'
                            }} onClick={livestream.hasNoTalentPool ? () => setModalStep(4) : () => setModalStep(3)}>Skip
                            </div>
                        </div>
                        <div className={modalStep !== 3 ? 'hidden' : 'modalStep'}>
                            <h4 className='booking-modal-subtitle'>Join the {livestream.company} Talent Pool</h4>
                            <div style={{margin: '0 0 40px 0'}}>Join {livestream.company}'s Talent Pool and be contacted
                                directly in case any relevant opportunity arises for you at {livestream.company} in the
