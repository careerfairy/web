...
const usersSelector = createSelector(
   ...
   (currentFilterGroupData, isFiltered) => {
      return isFiltered
         ? currentFilterGroupData?.filteredStudentsData.ordered
         : currentFilterGroupData?.totalStudentsData.ordered;
   }
);
...
const UserTableView = ({ isFiltered }) => {
   ...
   const users = useSelector((state) => usersSelector(state, { isFiltered }));
