...
const StreamerLinksDialogContent = ({livestreamId, handleClose, firebase}) => {
...
const StreamerLinksDialog = ({firebase, livestreamId, openDialog, setOpenDialog, onClose}) => {
    ...
    return (
        <Dialog open={openDialog} onClose={handleClose} fullWidth={true} maxWidth={'md'}
