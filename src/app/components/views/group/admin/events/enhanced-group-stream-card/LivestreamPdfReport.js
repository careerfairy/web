      ...
      <Document>
         <CFPage>
            ...
            <View>
               ...
               <DateText>
                  {DateUtil.getPrettyDate(livestream.start.toDate())}
               </DateText>
               ...
               {group.universityCode && (
                  <Fragment>
                     <TotalViewer>
                        Total Number Of Participating Students from{" "}
                        {group.universityName}: {totalViewerFromETH}
                     </TotalViewer>
                     <TotalViewer>
                        Total Number Of Participating Students from outside{" "}
                        {group.universityName}: {totalViewerFromOutsideETH}
                     </TotalViewer>
                  </Fragment>
               )}
               {!group.universityCode && (
                  <Fragment>
                     <TotalViewer>
                        ...
                        {totalViewerFromETH + totalViewerFromOutsideETH}
                     </TotalViewer>
                  </Fragment>
               )}
               <TotalViewer>
                  Total Number Of Students registered to the Talent Pool:{" "}
                  {totalStudentsInTalentPool}
               </TotalViewer>
               <CategoriesParent>
                  <Border>
