...
const General = ({
   ...
   const compareRegistrations = () => {
      ...
      const registrationsFromBeforeTimeFrame = getTotalEmailsFromStreamsByProperty(
         streamsFromBeforeTimeFrame,
         "registeredUsers"
      ).length;
   ...
   const compareUniqueRegistrations = (prop) => {
      ...
      const uniqueUsersFromTimeFrame = getUniqueIds(totalUsersFromTimeFrame)
         .length;
   ...
   const registrationsStatus = useMemo(() => compareRegistrations(), [
      streamsFromTimeFrameAndFuture,
      streamsFromBeforeTimeFrame,
   ]);
