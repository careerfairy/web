...
const ProfilePrivacyPolicy = ({group, firebase, className, ...rest}) => {
        ...
        return (
            <Formik
                ...
                validate={(values) => {
                    let errors = {}
                    if (values.privacyPolicyActive === true && (!values.privacyPolicyUrl || !values.privacyPolicyUrl.match(URL_REGEX))) {
                            ...
                            >
                                ...
                                >
                                    <FormControl fullWidth>
                                        ...
                                        />
                                        <Collapse
                                            in={Boolean(errors.privacyPolicyUrl && touched.privacyPolicyUrl && errors.privacyPolicyUrl)}>
                                ...
                                >
                                    ...
                                    >
                                        <FormControlLabel
                                            label="Activate"
                                            control={
                                                <Switch checked={values.privacyPolicyActive}
                                                        onChange={handleChange}
                                                        color="primary"
