...
function CompanyLandingPage(props) {
   ...
   function playVideoInFirstSection() {
      ...
      if (
         props.fullpageApi &&
         props.fullpageApi.getActiveSection().isFirst &&
         video.paused
      ) {
         video.play();
      }
   ...
   return (
      <div id="landingSection">
         <div className="mask">
            ...
            <div className="maskContent">
               ...
               >
                  ...
                  <Button
                     ...
                     color="primary"
                     variant="outlined"
                     onClick={() => props.scrollToSecond()}
                  >
                     Discover {props.company.name}
                  </Button>
                  <Button
                     style={{
                        display: "inline",
            ...
            <video
               id="background-video"
               key={props.company.backgroundUrl}
               autoPlay
               muted
               loop
               playsInline
         ...
         <style jsx>{`
            ...
            .titleFooter #footer_icon,
            .landingFooter #footer_icon {
               color: white;
               margin-bottom: 10px;
            }
