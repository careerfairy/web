...
const Step4Mic = ({
   ...
   const handleTestAgain = () => {
      ...
      const index = localMicrophones.findIndex(
   ...
   const micNumber = () => {
      return localMicrophones.findIndex(
         (device) => device.value === audioSource
      );
   };
   ...
   const handleCantHear = () => {
      ...
      const uncheckedSpeakers = [...localMicrophones].filter(
      ...
      <Grid container spacing={4}>
         ...
         >
            ...
            >
               <b>
                  {allTested
                     ? "We have tested all your Microphones"
                     : "Speak into the microphone. Do you see the indicator moving?"}
               </b>
            </Typography>
               ...
               {allTested ? (
                  ...
                  >
                     <Typography color="error" align="center" gutterBottom>
                        Make sure your Microphone and camera are not in use by
                        another app
                     </Typography>
            ...
            {clickedNo && !allTested && (
               <Typography align="center">
                  You have {localMicrophones.length} microphones, Now testing
                  microphone {micNumber() + 1}...{" "}
               </Typography>
            )}
         </Grid>
      </Grid>
