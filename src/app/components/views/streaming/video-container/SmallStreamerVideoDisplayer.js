   ...
   return (
      <Fragment>
         <div
            style={{
               position: "absolute",
               top: showBreakoutAlert
                  ? `calc(20vh + ${BREAKOUT_BANNER_HEIGHT}px)`
                  : "20vh",
               width: "100%",
...
const SharedScreenViewer = (props) => {
   ...
   const screenShareStream = props.externalMediaStreams?.find((stream) =>
      stream.uid.includes("screen")
   );
            ...
            {!props.isLocalScreen && screenShareStream ? (
               <RemoteVideoContainer
                  ...
                  height={
                     windowSize.width > 768
                        ? `calc(80vh - ${props.topDisplacement}px)`
                        : "80vh"
                  }
                  index={0}
               />
               ...
               <div
                  ...
                  style={{
                     ...
                     width: "100%",
                     height:
                        windowSize.width > 768 || props.isStreamer
                           ? `calc(80vh - ${props.topDisplacement}px)`
                           : "80vh",
                     backgroundColor: "rgb(30,30,30)",
                  }}
