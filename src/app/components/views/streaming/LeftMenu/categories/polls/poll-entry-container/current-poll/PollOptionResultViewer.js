   ...
   return (
      <Fragment key={props.index}>
         <div className="option-container">
            <div>
               <div
                  className="option-container-bar-element"
                  style={{
                     backgroundColor: colors[props.index],
                     width: getBarWidth(props.option.votes),
                  }}
               ></div>
            </div>
            <div className="option-container-label">
               <div
                  className="option-container-index"
               ...
               <div className="option-container-name">
                  {props.option.name}{" "}
                  <span className="option-container-name-votes">
                     [{props.option.votes}{" "}
                     {props.option.votes === 1 ? "vote" : "votes"}]
                  </span>
               </div>
            </div>
         </div>
