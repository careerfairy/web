    ...
    return (
        <GeneralLayout>
            <div className='cookies-background'>
                <Container>
                    <h1>Cookie Policy</h1>
                    <p>This is the Cookie Policy for CareerFairy, accessible from www.careerfairy.io</p>
                    ...
                    <h3>Contact</h3>
                    <p>In case you would like to request more detailed information regarding our use of cookies, you may contact us at:</p>
                    <ul>
                        <li>
