...
function LogInPage({ firebase }) {
   ...
   return (
      <TealBackground>
         ...
         <LogInForm
            userEmailNotValidated={userEmailNotValidated}
            absolutePath={absolutePath}
            setUserEmailNotValidated={(value) =>
               setUserEmailNotValidated(value)
            }
            setGeneralLoading={(value) => setGeneralLoading(value)}
                  ...
                  <Box boxShadow={1} p={3} className={classes.box}>
                     <form className={classes.form} onSubmit={handleSubmit}>
                        ...
                        >
                           ...
                           <p>
                              We sent you an email verification link to this
                              email address. Please click on it to start your
                              journey on CareerFairy.
                           </p>
                           <a
                              href="#"
                              onClick={() =>
                                 resendEmailVerificationLink(values.email)
                              }
                           >
                        ...
                        <Paper
                           elevation={3}
                           className={classes.message}
                           hidden={!emailVerificationSent}
                        >
                           <Typography variant="h6" gutterBottom>
                              Verification Email Sent
                           </Typography>
                           <p>
                              We have a just send an email verification link to
                              the address you provided. Please click on it to
                              start your journey on CareerFairy.
                           </p>
                        </Paper>
                     </form>
                  </Box>
