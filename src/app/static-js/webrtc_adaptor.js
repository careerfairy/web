export function WebRTCAdaptor(initialValues) {
	...
	this.openStream = function(mediaConstraints) {
		...
		if (mediaConstraints.audio !== undefined && mediaConstraints.audio !== false) {
			audioConstraint = mediaConstraints.audio;
		}
		if (mediaConstraints.video !== undefined && mediaConstraints.video === "screen") {
    ...
    if (!this.isPlayMode && typeof thiz.mediaConstraints != "undefined")  {
		// if it is not play mode and media constraints are defined, try to get user media
	...
	this.enableMicInMixedAudio = function(enable) {
        console.log("enableMicInMixedAudio");
	...
	this.switchVideoCapture = function(streamId) {
        console.log("switchVideoCapture");
	...
	this.initPeerConnection = function(streamId) {
		...
		if (thiz.remotePeerConnection[streamId] == null) 
		{
			...
			console.log(JSON.stringify(thiz.peerconnection_config));
	...
	this.turnOffLocalCamera = function() {
        console.log("turnOffLocalCamera");
