...
export function WebRTCAdaptor(initialValues)
{
	...
	/**
	 * Closes stream, if you want to stopÃ‚ peer connection, call stop(streamId)
	 */
	...
	/**
	 * If we have multiple videoÃ‚ tracks in coming versions, this method may cause some issues
	 */
