...
import {Button, DialogActions, DialogContent, DialogTitle, Slide, TextField} from "@material-ui/core";
    ...
    const {
        ...
        onSubmit: async values => {
            try {
                ...
                await sendBroadcastToBreakoutRooms(announcement, livestreamId, authorData)
                handleClose()
            } catch (e) {
...
const AnnouncementModal = ({open, onClose}) => {
    ...
    return (
        <GlassDialog TransitionComponent={Slide} onClose={handleClose} open={open}>
