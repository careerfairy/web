...
exports.sendEmailToStudentOfUniversityAndField = functions.https.onRequest(async (req, res) => {
    ...
    const emailsToRemove = ["christina.habetler@tucareer.com", "michaela.unger@tucareer.com", "susanne.leeb@tucareer.com", "julia.hainitz@tucareer.com", "christine.kaiser@hr.ethz.ch", "evelyne.kappel@hr.ethz.ch", "ekappel@gmx.ch,", "franziska.liese@hr.ethz.ch", "anja.pauling@hr.ethz.ch", "lorena.coletti@hr.ethz.ch",  "stephan.burkart@fhnw.ch", "sibylle.graf@fhnw.ch", "csc.business@fhnw.ch",  "wels@zhaw.ch", "spib@zhaw.ch",  "birgit-helga.mueller@unibas.ch", "n.astitouh@unibas.ch",
        "john.imonopi@lernende.ethz.ch", "michael.grunder@hr.ethz.ch", "daniela.gunz@uzh.ch", "roger.gfroerer@careerservices.uzh.ch", "sabine.demerle@epfl.ch", "cc@epfl.ch", "regina.cardoso@epfl.ch", "philippe.ory@epfl.ch"]
