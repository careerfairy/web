 ...
 */
export const setUserDataSet =
   (getUsersByEmail) => async (dispatch, getState) => {
      ...
      const dictionaryOfUsers =
         AnalyticsUtil.convertArrayOfUserObjectsToDictionary(totalUsers)
      dispatch({
...
export const setFilteredUserDataSet = () => async (dispatch, getState) => {
   ...
   const dictionaryOfFilteredUsers =
      AnalyticsUtil.convertArrayOfUserObjectsToDictionary(totalFilteredUsers)
   dispatch({
