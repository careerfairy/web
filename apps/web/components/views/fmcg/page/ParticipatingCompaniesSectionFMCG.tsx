...
interface ParticipatingCompaniesSectionFMCGProps {
   companies: Group[]
}

export default function ParticipatingCompaniesSectionFMCG({
   companies,
}: ParticipatingCompaniesSectionFMCGProps) {
   return (
      <Stack sx={styles.section}>
         <Stack sx={styles.sectionTitleWrapper} spacing={1.5}>
            <Typography variant="desktopBrandedH4" sx={styles.sectionTitle}>
               Featured FMCG companies
            </Typography>
            <Typography variant="brandedBody" sx={styles.sectionDescription}>
               Get exclusive insights from leading consumer goods companies.
               Learn about their brands, company culture, career opportunities,
