...
interface HeroSectionFMCGProps {
   panelEvents: LivestreamEvent[] // These are now FMCG livestreams, not panels
   handleOpenLivestreamDialog: (livestreamId: string) => void
}

export default function HeroSectionFMCG({
   panelEvents,
   handleOpenLivestreamDialog,
}: HeroSectionFMCGProps) {
         ...
         <Stack sx={styles.headerContainer}>
            ...
            <Stack sx={styles.rightColumn}>
               <Typography variant="medium" sx={styles.brandTagline}>
                  Join live sessions with Europe&apos;s leading FMCG companies
                  packed with career insights and real stories from industry
                  professionals.
               </Typography>

               <Stack sx={styles.tagChips}>
                  <Chip
                     label="Talk to FMCG professionals"
                     size="small"
                     sx={styles.tagChip}
                  />
                  <Chip
                     label="Career tips & insights"
                     size="small"
                     sx={styles.tagChip}
                  />
                  <Chip
