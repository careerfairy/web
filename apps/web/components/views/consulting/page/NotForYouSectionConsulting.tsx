...
interface NotForYouSectionConsultingProps {
   recentLivestreams: LivestreamEvent[]
   handleOpenLivestreamDialog: (livestreamId: string) => void
}

export default function NotForYouSectionConsulting({
   recentLivestreams,
   handleOpenLivestreamDialog,
}: NotForYouSectionConsultingProps) {
            ...
            title={
               <Stack sx={{ gap: 0.5, mb: 1.5 }}>
                  ...
                  <Typography variant="medium" sx={styles.sectionDescription}>
                     Explore other career-focused live streams
                  </Typography>
               </Stack>
            }
         />
