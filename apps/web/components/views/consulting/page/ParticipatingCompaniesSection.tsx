      ...
      <Stack sx={styles.section}>
         <Stack sx={styles.sectionTitleWrapper} spacing={1.5}>
            <Typography variant="desktopBrandedH4" sx={styles.sectionTitle}>
               Discover leading consulting firms
            </Typography>
            <Typography variant="brandedBody" sx={styles.sectionDescription}>
               Explore opportunities with prestigious consulting companies that are shaping the future of business. Learn about their culture, career paths, and what makes each firm unique in the consulting landscape.
            </Typography>
         </Stack>
