...
const takeaways = [
   "Exclusive insights from top consulting professionals",
   "Career guidance and industry best practices",
   "Networking opportunities with consulting leaders",
   "Access to replay and additional resources",
]
