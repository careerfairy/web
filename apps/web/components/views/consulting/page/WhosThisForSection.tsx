...
const styles = sxStyles({
   ...
   icon: {
      ...
      alignItems: "center",
      justifyContent: "center",
      color: (theme) => theme.brand.tq[800],
      fontWeight: 600,
   },
   sectionTitle: {
      color: "text.primary",
...
export default function WhosThisForSection() {
   const targetAudience = [
      {
         text: "Business students interested in consulting careers",
         icon: GraduationCapIcon,
      },
      {
         text: "Recent graduates exploring consulting opportunities",
         icon: JobsIcon,
      },
      {
         text: "Professionals looking to transition into consulting",
         icon: BriefcaseIcon,
      },
      {
         text: "Anyone curious about consulting industry insights",
         icon: TrendingUpIcon,
      },
   ]
