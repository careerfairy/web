      ...
      <Stack sx={styles.section}>
         <Stack sx={styles.sectionTitleWrapper} spacing={1.5}>
            ...
            <Typography variant="brandedBody" sx={styles.sectionDescription}>
               Connect with seasoned consulting professionals from top firms who have navigated successful careers in the industry. Learn about their journeys, gain insights into the consulting world, and discover what it takes to excel in this competitive field.
            </Typography>
         </Stack>
