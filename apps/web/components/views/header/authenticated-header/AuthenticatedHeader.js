...
const AuthenticatedHeader = (props) => {
   ...
   const eth_logo =
      "https://firebasestorage.googleapis.com/v0/b/careerfairy-e1fd9.appspot.com/o/company-logos%2Feth-career-center.png?alt=media&token=9403f77b-3cb6-496c-a96d-62be1496ae85"
   ...
   return (
      <Fragment>
         <header id="main-header">
            ...
            >
               <li
                  className={props.page === "next-livestreams" ? "active" : ""}
               >
               ...
               <li className={props.page === "groups" ? "active" : ""}>
