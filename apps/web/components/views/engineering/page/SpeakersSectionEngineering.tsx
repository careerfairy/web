...
const styles = sxStyles({
   ...
   // Purple image - top left of speakers grid (swapped colors for engineering theme)
   visualSupportLeft: {
      position: "absolute",
      left: 0,
      top: 0,
   ...
   // Turquoise image - bottom right of speakers grid (swapped colors for engineering theme)
   visualSupportRight: {
      position: "absolute",
      right: 0,
      bottom: 0,
...
interface SpeakersSectionEngineeringProps {
   speakers: Speaker[]
   companies: Group[]
}

export default function SpeakersSectionEngineering({
   speakers,
   companies,
}: SpeakersSectionEngineeringProps) {
   return (
      <Stack sx={styles.section}>
         <Stack sx={styles.sectionTitleWrapper} spacing={1.5}>
            ...
            <Typography variant="brandedBody" sx={styles.sectionDescription}>
               Connect with experienced engineers from leading companies who have
               navigated the competitive engineering landscape. Learn from their
               experiences, get insider tips on technical interviews, and discover
               what it really takes to break into engineering.
            </Typography>
         </Stack>
