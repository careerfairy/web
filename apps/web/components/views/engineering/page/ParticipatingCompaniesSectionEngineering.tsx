...
const styles = sxStyles({
   ...
   // Turquoise image - top left of companies grid (swapped for engineering theme)
   visualSupportLeft: {
      position: "absolute",
      left: 0,
      top: 0,
   ...
   // Purple image - bottom right of companies grid (swapped for engineering theme)
   visualSupportRight: {
      position: "absolute",
      right: 0,
      bottom: 0,
...
interface ParticipatingCompaniesSectionEngineeringProps {
   companies: Group[]
}

export default function ParticipatingCompaniesSectionEngineering({
   companies,
}: ParticipatingCompaniesSectionEngineeringProps) {
   return (
      <Stack sx={styles.section}>
         <Stack sx={styles.sectionTitleWrapper} spacing={1.5}>
            <Typography variant="desktopBrandedH4" sx={styles.sectionTitle}>
               Featured engineering companies
            </Typography>
            <Typography variant="brandedBody" sx={styles.sectionDescription}>
               Get exclusive insights from leading engineering companies across
               various industries. Learn about their technologies, engineering
               cultures, hiring processes, and what they look for in candidates.
            </Typography>
         </Stack>
