...
const securityHeaders = [
   ...
   // },
   {
      ...
      value:
         "default-src blob: 'self' js.hs-scripts *.vitals.vercel-insights.com *.googleapis.com *.graphassets.com *.graphcms.com calendly.com *.calendly.com *.gstatic.com *.google-analytics.com *.g.doubleclick.net *.kozco.com *.facebook.com; " +
         "script-src blob: 'self' static.hotjar.com *.vitals.vercel-insights.com snap.licdn.com *.googleapis.com *.googletagmanager.com *.google-analytics.com *.facebook.net 'unsafe-inline' 'unsafe-eval' cdnjs.cloudflare.com; " +
