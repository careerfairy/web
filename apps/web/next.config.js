...
const securityHeaders = [
   ...
   // },
   {
      ...
      value:
         "default-src blob: 'self' *.hotjar.com *.vitals.vercel-insights.com *.googleapis.com calendly.com *.calendly.com *.gstatic.com *.google-analytics.com *.g.doubleclick.net *.kozco.com *.facebook.com; " +
         "script-src blob: 'self' js.hs-scripts.com js.hs-banner.com js.hs-analytics.net js.hsadspixel.net *.hotjar.com *.vitals.vercel-insights.com snap.licdn.com *.googleapis.com *.googletagmanager.com *.google-analytics.com *.facebook.net 'unsafe-inline' 'unsafe-eval' cdnjs.cloudflare.com; " +
