...
const securityHeaders = [
   ...
   // },
   {
      ...
      value:
         "default-src blob: 'self' js.hs-scripts.com *.vitals.vercel-insights.com *.googleapis.com calendly.com *.calendly.com *.gstatic.com *.google-analytics.com *.g.doubleclick.net *.kozco.com *.facebook.com; " +
