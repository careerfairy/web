...
const securityHeaders = [
   ...
   // },
   {
      ...
      value:
         "default-src blob: 'self' *.js.hs-scripts *.vitals.vercel-insights.com *.googleapis.com *.graphcms.com calendly.com *.calendly.com *.gstatic.com *.google-analytics.com *.g.doubleclick.net *.kozco.com *.facebook.com; " +
...
const moduleExports = {
   ...
   images: {
      domains: ["firebasestorage.googleapis.com", "media.graphcms.com"],
   },
