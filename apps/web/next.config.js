...
const securityHeaders = [
   ...
   // },
   {
      ...
      value:
         ...
         "script-src blob: 'self' js.hs-scripts.com *.vitals.vercel-insights.com snap.licdn.com *.googleapis.com *.googletagmanager.com *.google-analytics.com *.facebook.net 'unsafe-inline' 'unsafe-eval' cdnjs.cloudflare.com; " +
